...
type CancelCustomerData = { name: string};
...
export default function CancelContent({ searchParams,}: { searchParams: Promise<SearchParams>}) {
  const { token } = use(searchParams);
  const [customerData, setCustomerData] = useState<CancelCustomerData | null>( null);
