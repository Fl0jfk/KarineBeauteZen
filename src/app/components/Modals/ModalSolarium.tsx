...
export default function ModalSolarium() {
    ...
    return (
        <section ref={modalRef} className={`${modalIsVisibleClass} w-full h-full relative flex flex-col gap-4 mt-4`}>
            {data.categories[5]&& <p className="text-4xl text-white text-sm">{data.categories[5].name}</p>}
