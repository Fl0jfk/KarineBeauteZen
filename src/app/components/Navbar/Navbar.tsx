    ...
    return (
        <>
            <AnimatePresence>
                {menuOpened && 
                    <motion.nav 
                            className={`md:${menuOpen} sm:${menuOpen} gap-10 text-2xl flex flex-col justify-center top-0 left-0 fixed pt-10 items-center w-full h-[100vh] z-[9] xl:hidden lg:hidden`}
                        ...
                        <div className={`flex flex-col gap-10 justify-center items-center w-full ${restOfMenu}`}>
                            ...
                            <Link className='hover:scale-110' href="/portfolio" onClick={handleLinkClick} aria-label="Lien vers la page portfolio">Portfolio</Link>
