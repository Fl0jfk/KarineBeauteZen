...
const Dropdown: React.FC<DropdownProps> = ({ title, items }) => {
  ...
  return (
    <div>
      <button onClick={toggleDropdown} className="w-full text-left px-4 py-2 bg-[#F2E9EB] text-2xl underline rounded-md flex items-center justify-between">
        {title}
      ...
      {isOpen && (
        <div className="mt-2 px-4 py-2 border border-gray-300 rounded-md shadow-md bg-[#F2E9EB]">
