...
const Dropdown: React.FC<DropdownProps> = ({ title, items }) => {
  ...
  return (
    <div className="relative">
      <button onClick={toggleDropdown} className="w-full text-left px-4 py-2 bg-rose-100 rounded-md flex items-center justify-between">
        {title}
      ...
      {isOpen && (
        <div className="mt-2 px-4 py-2 bg-white border border-gray-300 rounded-md shadow-md">
