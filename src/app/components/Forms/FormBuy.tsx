    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} name='form email' className='flex flex-col gap-3'>
            <div className='flex gap-4'>
                ...
                className='w-full rounded-full border border-gray-300 px-6 text-base font-medium text-gray-700 outline-none focus:border-black-500 focus:shadow-md text-black'
            ...
            <div className='flex gap-4'>
                ...
                placeholder='40, route du Neubourg'
                className='w-full rounded-full border border-gray-300 px-6 text-base font-medium text-gray-700 outline-none focus:border-black-500 focus:shadow-md text-black'
            ...
            <div className='flex gap-4'>
                ...
                id='city'
                autoComplete='city'
                placeholder='Saint-Pierre-des-Fleurs'
                className='w-full rounded-full border border-gray-300 px-6 text-base font-medium text-gray-700 outline-none focus:border-black-500 focus:shadow-md text-black'
                {...register('city', { required: true })}
                />
            </div>
           <button className="bg-[#F2E9EB] p-2 rounded-md text-black" onClick={Checkout}>Payer : {amount}€</button>
           <p className='text-[10px]'>Vous allez être redirigé vers notre partenaire
                <svg className='ml-1 inline' width="30px" height="30px" viewBox="0 -149 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
